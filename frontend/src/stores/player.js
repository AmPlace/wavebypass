  ...
  actions: {
    ...
    async playIptvChannel(channel) {
      ...
      const inferSourceType = (url) => {
        ...
        if (value.startsWith('migu://') || value.startsWith('hnntv://') || value.startsWith('gzstv://') || value.startsWith('sxbc://') || value.startsWith('xjtv://') || value.startsWith('douyin://') || value.startsWith('douyu://') || value.startsWith('huya://') || value.startsWith('redbook://') || value.startsWith('tiktok://') || value.startsWith('kuaishou://') || value.startsWith('bilibili://') || value.startsWith('yy://') || value.startsWith('bigo://') || value.startsWith('blued://') || value.startsWith('soop://') || value.startsWith('netease://') || value.startsWith('pandatv://') || value.startsWith('maoer://') || value.startsWith('look://') || value.startsWith('flextv://') || value.startsWith('popkontv://') || value.startsWith('twitcasting://') || value.startsWith('baidu://') || value.startsWith('weibo://') || value.startsWith('kugou://') || value.startsWith('twitch://') || value.startsWith('huajiao://') || value.startsWith('showroom://') || value.startsWith('inke://') || value.startsWith('acfun://') || value.startsWith('haixiu://') || value.startsWith('liveme://') || value.startsWith('zhihu://') || value.startsWith('chzzk://') || value.startsWith('17live://') || value.startsWith('langlive://') || value.startsWith('changliao://') || value.startsWith('jd://') || value.startsWith('faceit://') || value.startsWith('lianjie://') || value.startsWith('sixroom://') || value.startsWith('lehai://') || value.startsWith('huamao://') || value.startsWith('shopee://') || value.startsWith('laixiu://') || value.startsWith('picarto://') || value.startsWith('ytsl://') || value.startsWith('youtube://') || value.startsWith('adapter://')) return 'adapter'
