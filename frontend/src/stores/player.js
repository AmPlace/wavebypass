  ...
  actions: {
    ...
    async playIptvChannel(channel) {
      ...
      const inferSourceType = (url) => {
        ...
        if (value.startsWith('migu://') || value.startsWith('douyin://') || value.startsWith('douyu://') || value.startsWith('huya://') || value.startsWith('redbook://') || value.startsWith('tiktok://') || value.startsWith('kuaishou://') || value.startsWith('bilibili://') || value.startsWith('yy://') || value.startsWith('adapter://')) return 'adapter'
