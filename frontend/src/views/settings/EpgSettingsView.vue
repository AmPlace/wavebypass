<template>
  <section aria-labelledby="epg-settings-title">
    <header class="mb-5">
    ...
    <nav
      ref="tabsRef"
      class="settings-secondary-tabs scrollbar-hide mb-6 flex max-w-full gap-6 overflow-x-auto border-b border-[var(--border)]"
      aria-label="EPG 设置分类"
    >
      <RouterLink
