...
test('安全设置只复用既有 API 并保留 forced 字段语义', () => {
  ...
  assert.match(security, /allow_private/)
  assert.match(security, /allow_loopback/)
  assert.match(security, /session_max_age_days/)
  assert.match(security, /media_credential_default_ttl_days/)
